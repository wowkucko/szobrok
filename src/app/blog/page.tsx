...
export const metadata: Metadata = {
  ...
  description:
    "3D nyomtatott, kézzel festett szobrok és gyűjtői figurák — inspiráció, tervezői bemutatók és kedvezmények a műhely blogján.",
};

export const dynamic = "force-dynamic";

export default function BlogPage() {
  const { total, posts } = listBlogPosts(60, 0);
